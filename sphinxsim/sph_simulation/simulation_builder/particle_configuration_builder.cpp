    ...
    SPHSimulation &sim, MainMethods &main_methods, const json &config)
{
    ...
    auto &fluid_bodies_config = config_manager.getEntity<StdVec<SPHBodyConfig *>>("FluidBodiesConfig");
    auto &continuum_bodies_config = config_manager.getEntity<StdVec<SPHBodyConfig *>>("ContinuumBodiesConfig");
    ...
    if (!update_cell_linked_list.hasDynamics())
        return;
    ...
    SPHSimulation &sim, MainMethods &main_methods, const json &config)
{
    ...
    if (!update_all_fluid_relations.hasDynamics())
        return;
    ...
    SPHSimulation &sim, MainMethods &main_methods, const json &config)
{
    ...
    if (!update_all_continuum_relations.hasDynamics())
        return;
    ...
    SPHSimulation &sim, MainMethods &main_methods, const json &config)
{
    ...
    if (!update_all_contact_relations.hasDynamics())
        return;
